        ...
        <div class="grid grid-cols-2 border border-slate-50/[0.06] rounded-md overflow-hidden">
            ...
            <form action="post" class="flex flex-col p-10">
                ...
                <fieldset class="flex flex-col-reverse mt-4">
                    <input placeholder=" " id="email" name="email" type="email" class="bg-transparent border-b outline-none border-slate-50/[0.06] placeholder-shown:h-0 h-5 focus:h-5 duration-200 peer text-slate-400 focus:text-violet-400 pb-1"/>
                ...
                <fieldset class="flex flex-col-reverse mt-4">
                    <input placeholder=" " id="passwordConfirm" name="passwordConfirm" type="passwordConfirm" class="bg-transparent border-b outline-none border-slate-50/[0.06] placeholder-shown:h-0 h-5 focus:h-5 duration-200 peer text-slate-400 focus:text-violet-400 pb-1"/>
